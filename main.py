...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        if '/ban' in msgText:
            ...
            if isadmin:
                try:
                    ...
                    jdb.remove(user)
                    jdb.save()
                    msg = 'El usuario @'+user+' fue baneado❌'
                    bot.sendMessage(update.message.chat.id,msg)
                except:
        ...
        if '/zip' in msgText:
            ...
            if getUser:
                try:
                   ...
                   jdb.save()
                   msg = 'Ahora los zips serán de '+ sizeof_fmt(size*1024*1024)+' las partes'
                   bot.sendMessage(update.message.chat.id,msg)
                except:
        ...
        if '/start' in msgText:
            start_msg = 'Bot          : MoodleBot Down/Up\n'
            start_msg+= 'Administrador: @User0075_69\n'
...
def main():
    ...
    bot = ObigramClient(5223817057:AAHWtUx6ZIfdMwnR1UxA7TBPKCyd5Ty10hw)
